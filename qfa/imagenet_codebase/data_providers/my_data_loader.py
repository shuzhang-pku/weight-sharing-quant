    ...
    try:
        ...
        while watchdog.is_alive():
            ...
            if r is None:
                ...
                continue
            idx, batch_indices = r
            LoaderConfig.sample_image_size(idx)
            try:
...
def default_collate(batch):
    ...
    if isinstance(batch[0], torch.Tensor):
        ...
        return batch
    elif isinstance(batch[0], container_abcs.Mapping):  # this allows batch of dicts with tensors as values
...
class _DataLoaderIter(object):
    ...
    def __next__(self):
        if self.num_workers == 0:  # same-process loading
            LoaderConfig.sample_image_size(0)
